...
function Lock(props) {
  ...
  var Router = '0xfF5C65548e5eFa03A108cb645E2Cf2462Fb36d35'
  var RouterLUNG = props.routerLUNG  
          ...
          <div className="row justify-content-center align-items-center">
            <div className="tabs-wrapper">
              <ul className="nav-tabs" role="tablist">
                <div>
                  <li className="nav-item tab is-active" data-role="tab" data-target="#tabs-home3" onClick={tab}>Frming</li>
                ...
                <div className="tab-panel is-active" id="tabs-home3" role="tabpanel">
                  <div className='checkout-form-centre'>
                    <div className='checkout-login-step'>
                      ...
                      <div className='apy'>
                        {timeperiod === 0 ? `APY up to 15%, Locked Until ${moment().add(7, "days").format("DD-MM-YYYY H:mm A")}`
                          : timeperiod === 1 ? `APY up to 20%, Locked Until ${moment().add(30, "days").format("DD-MM-YYYY H:mm A")}`
                            : timeperiod === 2 ? `APY up to 25%, Locked Until ${moment().add(60, "days").format("DD-MM-YYYY H:mm A")}`
                              : timeperiod === 3 ? `APY up to 30%, Locked Until ${moment().add(90, "days").format("DD-MM-YYYY H:mm A")}`
                                : `APY up to 50%, Locked Until ${moment().add(180, "days").format("DD-MM-YYYY H:mm A")}`
                        }</div>
